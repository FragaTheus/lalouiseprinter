package br.com.matheusfragadev.lalouise.infra.controller.user.profile;
...
public class ProfileController {
    ...
    public ResponseEntity<ProfileResponse> getProfile(
        ...
        return ResponseEntity.ok(ProfileMapper.toResponse
                (credentials, managerService::getRestaurantName, staffService::getSectorName, staffService::getRestaurantName));
    }
